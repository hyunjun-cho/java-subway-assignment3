...
public class MainOutputView {
    ...
    private static final String QUESTION_OPTION_CHOICE = Prefix.START.getPrefix() + "원하는 기능을 선택하세요.";
    ...
    public static void questionChoice() {
        System.out.println(QUESTION_OPTION_CHOICE);
    }
}